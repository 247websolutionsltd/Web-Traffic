        ...
        <ScrollView style={styles.profileContainer} showsVerticalScrollIndicator={false}>
            <SafeAreaView style={styles.profileTop}>
                ...
                <View style={{marginVertical:Spacing.three}}>
                    <ThemedText themeColor="background" type="subtitle">Tunde Adebayo</ThemedText>
                    <ThemedText themeColor="backgroundElement">Ikeja, Lagos · Member since 2022</ThemedText>
                </View>
            </SafeAreaView>
            <Stats/>
            <View>
